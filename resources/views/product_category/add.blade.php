                    ...
                    <div class="col-md-10 m-5">
                        <form method="post" action="{{route ('product_categories.store')}}" >
                            ...
                            <div class="form-group row">
                                ...
                                <textarea class="form-control col-md-10" rows="3" name="introduction_vie"></textarea>
                            </div>
                            <div class="alert alert-dark" role="alert">
                                Hiển thị
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="home_page" value="1">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="Title SEO" name="title">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" placeholder="ULR-MAU." name="slug">
                            ...
                            <div class="form-group row">
                                ...
                                <textarea class="form-control col-md-10" rows="3" name="description"></textarea>
                            </div>
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Keyword</label>
                                <textarea class="form-control col-md-10" rows="3" name="keyword"></textarea>
                            </div>
